...
<div class="page-banner">
    <div
        ...
        style="background-image: url(<? echo get_theme_file_uri('/images/library-hero.jpg') ?>)"></div>
    ...
    <div data-glide-el="track" class="glide__track">
        <div class="glide__slides">
            <div
                ...
                style="background-image: url(<? echo get_theme_file_uri('/images/bus.jpg') ?>)">
            ...
            <div
                class="hero-slider__slide"
                style="background-image: url(<? echo get_theme_file_uri('/images/apples.jpg') ?>)">
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
                        <h2 class="headline headline--medium t-center">
                            An Apple a Day
            ...
            <div
                class="hero-slider__slide"
                style="background-image: url(<? echo get_theme_file_uri('/images/bread.jpg)') ?>">
                <div class="hero-slider__interior container">
                    <div class="hero-slider__overlay">
